...
// Welcome show summary of current Aura instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Aura metadata
	fmt.Fprintf(c.printer, "Welcome to the Aura JavaScript console!\n\n")
	c.jsre.Run(`

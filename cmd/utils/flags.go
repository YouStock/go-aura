...
// for Aura and returns half of the allowance to assign to the database.
...
// new format.
//
// e.g. aura account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// aura --keystore /tmp/mykeystore --lightkdf account new
//

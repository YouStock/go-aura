...
# 1. install aura for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for aura
# 5. create aura, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since aura is installed global
